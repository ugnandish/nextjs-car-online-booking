...
CarFiltersOption.tsx <br/>
```
import React, { useEffect, useState } from 'react'

const CarsFiltersOption = ({carsList,setBrand,orderCardList}:any) => {
  ...
  return (
    <div className='mt-10 flex items-center justify-between'>
      ...
      <div className='flex gap-5'>
        <select className="select select-bordered w-full max-w-xs" onChange={(e)=>orderCardList(e.target.value)}>
          <option disabled selected>Price</option>
...
export default function Home() {
  ...
  return (
    <div className="p-5 sm:px-10 md:px-20">
      ...
      orderCardList={(value:string)=>orderCarList(value)}
